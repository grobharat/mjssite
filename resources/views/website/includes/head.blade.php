  ...
  <!-- Favicons -->
  <link href="website/img/favicon/favicon-16x16.png" rel="icon">
  <link href="website/img/favicon/favicon-32x32.png" rel="icon">
  <link href="website/img/favicon/apple-touch-icon.png" rel="apple-touch-icon">
